...
elif (height_cm >= 120) and (height_cm <= 139):
...
if finished_homework == True and read_book == True and helped_at_home == True :
    print("You earned bonus game time!")
elif finished_homework == True and read_book == True  and helped_at_home == False:
...
if word == 'dragon' or word == 'phoenix' :
...
if is_vip == True:
    print("Welcome, VIP!")
elif has_ticket == True and age >= 7 :
...
if player_element == "water" and enemy_element == "water" :
    print("Draw!")
