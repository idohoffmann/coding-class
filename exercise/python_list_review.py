...
answer_2_1 = animals[7]   # should be "hawk"
check("2.1 Last animal", answer_2_1, "hawk")

answer_2_2 = animals[6]   # should be "goat"
check("2.2 Second last animal", answer_2_2, "goat")

answer_2_3 = animals[5]   # should be "fox"
...
answer_3_5 = numbers[0:4]       # should be [10, 11, 12, 13]
...
answer_5_3 = letters[ :0:-2]   # should be ["h", "f", "d", "b"]
...
answer_6_2 = mission_log[7]          # should be "land", using negative index
...
answer_6_5 = mission_log[ :3:-1]  # should be ["land", "return", "take photo", "repair antenna"]
